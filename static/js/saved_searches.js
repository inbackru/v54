...
// ============================================
// SAVE SEARCH DROPDOWN FUNCTIONALITY
// ============================================
...
window.toggleSaveSearchDropdown = toggleSaveSearchDropdown;
window.closeSaveSearchDropdown = closeSaveSearchDropdown;
...
function attachSaveSearchListeners() {
    const saveSearchBtn = document.getElementById('saveSearchBtn');
    const saveSearchConfirmBtn = document.getElementById('saveSearchConfirmBtn');
    const saveSearchCancelBtn = document.getElementById('saveSearchCancelBtn');
    
    if (saveSearchBtn) {
        saveSearchBtn.addEventListener('click', toggleSaveSearchDropdown);
        console.log('✅ Save search button event listener attached');
    } else {
        console.log('⚠️ saveSearchBtn not found in DOM');
    }
    
    if (saveSearchConfirmBtn) {
        saveSearchConfirmBtn.addEventListener('click', saveSearchWithOptions);
    }
    
    if (saveSearchCancelBtn) {
        saveSearchCancelBtn.addEventListener('click', closeSaveSearchDropdown);
    }
}
...
function initSavedSearches() {
    try {
        // Attach save search button listeners first
        attachSaveSearchListeners();
